        ...
        <div class="clearfix colelem" id="middleContentPadding"><!-- group -->
			...
			<div id="thirtyThreeSplit">
                ...
                <div id="mainContent">
                   ...
                   <form:form method="POST" commandName="textBoxForm" action="${context}/getTextBoxForm.do">
                   
                   	<ul class="formFields">
                   		<li class="formFields"><label class="fieldLabel">Text Box:</label><span class="reqField">*</span><form:input type="text" path="textbox1" tabindex="1" required="required"/></li> 
                   		<li class="formFields"><label class="fieldLabel">Text Box:</label><span class="reqField">*</span><form:input type="text" path="textbox2" tabindex="2" required="required"/></li>
                   		
						<li class="formFields">
						<div style="vertical-align: bottom; overflow: auto;">
						<label class="fieldLabel">Text Box with mouse-over pop-up text:</label><span class="notReqField">&nbsp;</span><form:input type="text" path="textbox3" tabindex="3" title="mouse-over pop-up text"/>
						</div>
						</li>
						
						<li class="formFields">
							<div style="vertical-align: bottom; overflow: auto;">
							<label class="fieldLabel">Disabled Text Box:</label>
							<span class="notReqField">&nbsp;</span>
							<form:input type="text" path="textbox4" tabindex="4" disabled="true"/>
							</div>
						</li> 
					</ul>
