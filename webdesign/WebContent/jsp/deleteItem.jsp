        ...
        <div class="clearfix colelem" id="middleContentPadding"><!-- group -->
			...
			<div id="thirtyThreeSplit">
                ...
                <div id="mainContent">
                   ...
                   <span class="heading1">Delete Item</span><p>
                   <form:form method="POST" commandName="deleteItemForm" action="${context}/deleteItem.do">
                   
                  		<form:hidden path="deleteItemIndex"/>
						...
						<span class="confirmation">${message}</span>
                   		...
                   		<div id="buttonHolder" class="buttonHolder">
                   			<P>
                   			<P>
							<button type="submit" name="Delete" value="Delete" tabindex="1">Delete</button> 
							<button type="button" name="Done" value="Done" tabindex="2" onClick='window.location.href="${context}/getCommandButtonForm.do"'>Done</button> 
						</div>
