...
<script>
     ...
     $(function() {
    	 ...
    	 showOn: "button",
    	 buttonImage: "${context}/images/datepicker.png",
        ...
        <div class="clearfix colelem" id="middleContentPadding"><!-- group -->
			...
			<div id="thirtyThreeSplit">
                ...
                <div id="mainContent">
                   ...
                   <span class="heading1">Date Picker Example</span>
                   
                   
                <form:form method="POST" commandName="datePickerForm" action="${context}/getDatePickerForm.do">
                   	<ul class="formFields">
						<li class="formFields"><label class="fieldLabel">Date Picker:</label><form:input type="text" path="datepicker" tabindex="1" /></li>
					</ul>
