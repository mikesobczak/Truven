        ...
        <div class="clearfix colelem" id="middleContentPadding"><!-- group -->
			...
			<div id="thirtyThreeSplit">
                ...
                <div id="mainContent">
                   ...
                   <span class="heading1">Modify Item</span><p>
                   <form:form method="POST" commandName="modifyItemForm" action="${context}/modifyItem.do">
                   
                  <form:hidden path="modifyItemIndex"/>
					...
					<span class="confirmation">${message }</span>
                   		...
                   		<div id="buttonHolder" class="buttonHolder">
                   			...
                   			<P>
                   			<P>
                   			<label class="fieldLabel">Modify Item:</label><span class="requiredField">*</span><form:input type="text" path="modifyItemText" tabindex="1" required="required"/> 
                   			<P>
							<button type="submit" name="Modify" value="Modify" tabindex="2">Modify</button> 
