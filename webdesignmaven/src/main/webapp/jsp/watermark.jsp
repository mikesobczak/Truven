        ...
        <div class="clearfix colelem" id="middleContentPadding"><!-- group -->
			...
			<div id="thirtyThreeSplit">
                ...
                <div id="mainContent">
                   ...
                   <form:form method="POST" commandName="watermarkForm" action="${context}/getWatermarkForm.do">
                   	<ul class="formFields">
						<li class="formFields"><label class="fieldLabel">Text Box:</label><form:input type="text" path="textbox1" tabindex="1"  value="" /></li>
						<li class="formFields"><label class="fieldLabel">Text Box:</label><form:input type="text" path="textbox2" tabindex="2 " value="" /></li>
					</ul>
					Cursor in field hides watermark
...
<script type="text/javascript"> 
	// jQuery Watermark calls
	$(function () {
		$("#textbox1").watermark("MM/DD/YYYY");
		$("#textbox2").watermark("MM/DD/YYYY");
	});
