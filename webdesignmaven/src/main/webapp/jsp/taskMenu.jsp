			...
			<div id="thirtyThreeSplit">
            	...
            	<p>
					...
					<ul class="menu" id="menu1">
						<li id="taskmenu"><a href="${context}/jsp/taskMenu.jsp">Task Menu Example</a></li>
				...
				<script type="text/javascript">
                    	...
                    	$('.menu a[href="'+ url +'"]').addClass('menu-item-focus');
                ...
                <div id="mainContent">
                   ...
                   <span class="heading1">Task Menu Example</span>
